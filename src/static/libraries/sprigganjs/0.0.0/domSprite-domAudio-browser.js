var ContentManager = SprigganContentManager
var Viewport = SprigganViewport
var Sprite = SprigganSprite
var ContentImage = SprigganContentImage
var ContentText = SprigganContentText
var ContentJson = SprigganContentJson
var ContentSpriteSheet = SprigganContentSpriteSheet
var ContentSound = SprigganContentSound
var ContentMusic = SprigganContentMusic
var Move = SprigganMove
var Play = SprigganPlay
var Loop = SprigganLoop
var MoveOverSeconds = SprigganMoveOverSeconds
var Pause = SprigganPause
var Resume = SprigganResume
var Timer = SprigganTimer
var Group = SprigganGroup
var Remove = SprigganRemove
var Print = SprigganPrint
var Order = SprigganOrder
var EventOnce = SprigganEventOnce
var EventRecurring = SprigganEventRecurring
var MoveAtPixelsPerSecond = SprigganMoveAtPixelsPerSecond
var IgnoreClicks = SprigganIgnoreClicks
var AcceptClicks = SprigganAcceptClicks
...
function SprigganViewport(width, height, horizontalAlignment, verticalAlignment) {
    ...
    Resize()
    SprigganAllViewports.push(Resize)
    var output = {
        element: element
    }
    return output
